...
export enum LandingPageData {
    HERO_TEXT_ARABIC = "ٱلسَّلَامُ عَلَيْكُمْ",
    HERO_TEXT_ENGLISH = "As-salamu alaykum",
    HERO_TEXT_SUB_HEADING_L1 = "Welcome to the official homepage for MSA-MUN",
    HERO_TEXT_SUB_HEADING_L2 = "Muslim Students Association of Memorial University of Newfoundland",
    HERO_BUTTON_TEXT = "New to MUN? Click for all you need to know",
    DONATION_BUTTON_TEXT = "DONATE",
