    ...
    <>
        ...
        <div className="container d-flex flex-wrap">
          <ul className="nav ms-auto">
            <li className="nav-item">
              <a
                href={NavLink.Home}
                className="nav-link link-body-emphasis px-3 active"
                aria-current="page"
              >
                Home
              </a>
            ...
            <li className="nav-item">
              <a
                href={NavLink.Events}
                className="nav-link link-body-emphasis px-3"
              >
                Events
              </a>
            </li>
      ...
      <header className="py-3 px-3 mb-4 border-bottom">
        <div className="container d-flex flex-wrap justify-content-center">
          <Link
            href="/"
            className="d-flex align-items-center mb-3 mb-lg-0 me-auto link-body-emphasis text-decoration-none"
          >
            {/* <svg className="bi me-2" width="40" height="32"><use href="#bootstrap"></use></svg> */}
            <span className="fs-4 fw-bold bg-gradient m-0 py-1 px-3 animate-bg">
              MSA-MUN
            </span>
          </Link>
          ...
          <div className=" ms-3 mb-3 mb-lg-0 d-flex justify-content-center">
