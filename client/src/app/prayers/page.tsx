  ...
  return (
    <PageTemplate>
      <div className="col-12 col-md-4 d-flex flex-column">
        <span className="mt-1 text-dark fw-bold fs-3" >Prayers</span>
        <span className="mt-3 text-dark fs-5" >Musallahs</span>
        <span className="mt-3 text-dark fs-5" >Mashjid</span>
        <span className="mt-3 text-dark fs-5" >Jumma Prayers</span>
        <span className="mt-3 text-dark fs-5" >MANAL</span>
        <span className="mt-3 text-dark fs-5" >ICNA NL</span>
      </div>
